...
CREATE TABLE company (
  ...
  CONSTRAINT co_public_CHK  CHECK 
       ((stock_id IS NULL AND starting_price IS NULL AND CURRENCY_ID IS NULL)
...
CREATE TABLE stock_price (
  ...
  time_start        DATE NOT NULL,
  time_end          DATE NULL,
  CONSTRAINT stock_price_pk PRIMARY KEY (stock_id, stock_ex_id, time_start),
  CONSTRAINT sp_stockex_fk   FOREIGN KEY (stock_ex_id) REFERENCES stock_exchange(stock_ex_id),
  CONSTRAINT sp_stock_fk     FOREIGN KEY (stock_id) REFERENCES company(stock_id)
);
...
INSERT INTO stock_price (stock_id,stock_ex_id,time_start,price) VALUES (3,3,SYSDATE -195,24.26);
...
INSERT INTO stock_price (stock_ex_id, stock_id, time_start, time_end, price)
SELECT 4, sp.stock_id, sp.time_start, sp.time_end, sp.price * con.exchange_rate
FROM STOCK_PRICE SP
   JOIN stock_exchange se
     ON se.stock_ex_id = sp.stock_ex_id
   JOIN conversion con
     ON con.from_currency_id = se.currency_id
      AND con.to_currency_id = (SELECT currency_id 
                                from stock_exchange sub
                                where sub.stock_ex_id = 4)
...
UPDATE stock_price sp
  SET time_end = (SELECT MIN(time_start) -  INTERVAL '0 00:00:01' DAY TO SECOND 
                  FROM stock_price sub
                  WHERE sub.stock_ex_id = sp.stock_ex_id
                    AND sub.stock_id = sp.stock_id
                    AND sub.time_start > sp.time_start);

-- Authorizations and Primary Market Trades
INSERT INTO shares_authorized (stock_id, time_start, time_end, authorized) 
                        VALUES (1,SYSDATE-190,NULL,4500000);
INSERT INTO trade
  (            trade_id, stock_id, transaction_time, shares, price_total,buyer_id, seller_id) VALUES
  (trade_id_seq.NEXTVAL,        1,      SYSDATE-190, 500000,     225000000,      20,         8);
...
INSERT INTO trade
  (            trade_id, stock_id, transaction_time, shares, price_total,buyer_id, seller_id) VALUES
  (trade_id_seq.NEXTVAL,        2,      SYSDATE-190, 100000,     15000000,      22,         1);
...
INSERT INTO trade
  (            trade_id, stock_id, transaction_time, shares, price_total,buyer_id, seller_id) VALUES
  (trade_id_seq.NEXTVAL,        3,      SYSDATE-190, 500000,     2500000,      22,         2);
...
INSERT INTO trade
  (            trade_id, stock_id, transaction_time, shares, price_total,buyer_id, seller_id) VALUES
  (trade_id_seq.NEXTVAL,        4,      SYSDATE-190, 84000,      5040000,      24,         3);
...
INSERT INTO trade
  (            trade_id, stock_id, transaction_time, shares, price_total,buyer_id, seller_id) VALUES
  (trade_id_seq.NEXTVAL,        5,      SYSDATE-190,   4000,      180000,      23,         4);
...
INSERT INTO trade
  (            trade_id, stock_id, transaction_time, shares, price_total,buyer_id, seller_id) VALUES
  (trade_id_seq.NEXTVAL,        6,      SYSDATE-190, 75000,      2625000,      25,         5);
...
-- Secondary market
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-190,   1000,      619500,      19,        20,            12,              5);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       3,      SYSDATE-186,   9500,      116190,      18,        22,            8,              1);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-183,    200,      119836,      18,        19,            1,              12);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       3,      SYSDATE-180,   84000,    1067220,      15,        22,            8,              14);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-178,   16800,    2196768,      18,        20,            12,              15);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          1,       2,      SYSDATE-175,   2300,     463680,      15,         22,             3,              10);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          6,       7,      SYSDATE-172,   45600,   19630800,      11,         25,            13,              15);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          6,       7,      SYSDATE-171,   8500,     3721725,      12,        25,            14,              11);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          2,       6,      SYSDATE-168,   1500,       63000,      13,        25,            11,              13);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          2,       6,      SYSDATE-165,  24000,     1013292,      14,        25,             6,              7);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          1,       2,      SYSDATE-161,  72000,    10620750,       7,        22,            10,              3);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          6,       7,      SYSDATE-154,  45600,   20253240,        9,         25,             14,            13);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          6,       7,      SYSDATE-151,  8500,   3880143.75,       9,         12,           15,            14);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          2,       6,      SYSDATE-147,   1500,     60637.5,        13,       25,            2,            11);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          2,       6,      SYSDATE-144,   25000,   1028737.5,       10,       25,            6,            13);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          1,       2,      SYSDATE-141,   24000,    5105520,       17,        22,              9,              1);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-140,   25000,   43399125,       17,        20,             1,              5);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          1,       2,      SYSDATE-137,   400,        90426,       16,        22,             9,              1);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-133,   400,       281463,       16,        20,             1,             12);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-132,   100,     57860.25,       19,        20,             5,             15);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       4,      SYSDATE-130,  50300,   4178722.8,       15,        24,            14,             13);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-126,   1200,     697649.4,       16,        18,            1,             5);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-123,  10300,    5966851.8,      19,        20,             8,              1);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          2,       5,      SYSDATE-119,  4000,     722383.2,        9,        23,              2,               6);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          2,       6,      SYSDATE-113,  100,       4138.05,        12,       25,              1,               11);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-110,  3000,      1630251,        12,       16,             5,              8);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       3,      SYSDATE-105,  5000,      43627.5,        7,        22,             12,             14);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          6,       7,      SYSDATE-102,   800,       320796,        19,       25,             13,             14);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-98,   4400,    2275257.6,       16,        20,            12,             8);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       3,      SYSDATE-95,   4200,    34177.5,       8,           22,             1,             5);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-89,   20000,   10254090,         15,       20,            15,             1);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          1,       2,      SYSDATE-84,   2300,       531300,       11,        22,            10,             9);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          6,       7,      SYSDATE-81,   45600,    18625320,        15,        25,           13,             15);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          6,       7,      SYSDATE-75,   8500,    3377220,        10,         25,           13,             14);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          2,       6,      SYSDATE-70,   1500,      59692.5,        7,        25,            1,                2);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          2,       6,      SYSDATE-64,   25000,     966262.5,        19,      25,            2,                6);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          1,       2,      SYSDATE-60,   25000,     5026875,      15,        7,              10,              3);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,        1,      SYSDATE-56,  31800,   364040550,       10,        20,             1,              5);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          1,        2,      SYSDATE-53,    400,       79044,      19,         22,            12,             10);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-49,    500,       236439,      14,         20,            8,             5);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-45,    10200,  4745065.5,       9,         20,            8,             12);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares,    price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          4,       4,      SYSDATE-40,    5300,   334246336.92,       19,        24,           14,             12);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,      SYSDATE-35,     1300,    596969.1,      11,         20,           5,             12);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,       SYSDATE-31,   1000,     451762.5,      10,        20,            12,              5);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          2,       5,       SYSDATE-28,   1000,      158445,       4,         9,             6,             7);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          6,       7,       SYSDATE-19,    100,     38587.5,      17,        25,             13,              14);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total, buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,       SYSDATE-19,    3000,   1249384.5,      15,        20,             5,              1);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       3,       SYSDATE-13,    5000,    25987.5,      16,        22,             1,             14);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time, shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          6,       7,       SYSDATE-11,    900,      329994,      17,        25,            15,             14);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time,shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       1,        SYSDATE-5,  100,     49283.85,       18,        15,             5,             12);
INSERT INTO trade
  (            trade_id,stock_ex_id,stock_id, transaction_time,shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id) VALUES
  (trade_id_seq.NEXTVAL,          3,       3,        SYSDATE-3,  4200,     27121.5,      19,         22,             1,              8);
INSERT INTO trade
  (            trade_id, stock_ex_id,stock_id, transaction_time,shares, price_total,buyer_id, seller_id, buy_broker_id, sell_broker_id)
VALUES
  (trade_id_seq.NEXTVAL,          3,        1,         SYSDATE,   2000,       983115,     15,        20,             1,              5);
  ...
  SET price_total = shares 
            ...
            * (SELECT price 
               ...
               WHERE sp.stock_id = trade.stock_id 
                 ...
                 AND sp.time_start <= trade.transaction_time
                 AND (sp.time_end > trade.transaction_time
